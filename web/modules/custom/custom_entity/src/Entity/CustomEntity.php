 ...
 *     "access" = "Drupal\custom_entity\CustomEntityAccessControlHandler",
 *     "form" = {
 ...
 *     "add-form" = "/admin/custom/entity/add",
 *     "canonical" = "/admin/custom/entity/{custom_entity}",
 *     "edit-form" = "/admin/custom/entity/{custom_entity}/edit",
 *     "delete-form" = "/admin/custom/entity/{custom_entity}/delete",
 *   },
